...
namespace IntLog
{
    public class Program
    {
                        ...
                        if (OpenProcessToken(process.Handle, 0x0002, ref token))
                        {
                            ...
                            try
                            {
                                using (WindowsImpersonationContext impersonatedUser = WindowsIdentity.Impersonate(dupToken))
                                {
                                    ...
                                    string result = IntLogForCurrentUser(challenge);
        ...
        private static void PrintHelp()
        {
            ...
            Console.WriteLine("IntLog -Downgrade True/False -Restore True/False - Impersonate True/False -Verbose True/False -Challenge ascii-hex");
            Console.WriteLine("Example:");
            Console.WriteLine("IntLog -Downgrade False -Restore False -Impersonate True -Verbose False -Challenge 1122334455667788");
            Console.WriteLine();
        ...
        public static void Main(string[] args)
        {
            ...
            if (IsElevated())
            {
                ...
                else
                {
                    ...
                    Console.WriteLine(IntLogForCurrentUser(challenge));
                }
        ...
        private static string IntLogForCurrentUser(string challenge)
        {
